...
need_exec "scripts/sign_components.swift"
need_exec "scripts/sign_update.swift"
...
need_secret "XICO_COMPONENTS_URL"
need_secret "XICO_COMPONENTS_PUBLIC_KEYS"
need_secret "XICO_UPDATE_PUBLIC_KEYS"
